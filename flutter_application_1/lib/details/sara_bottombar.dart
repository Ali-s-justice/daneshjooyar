...
class SaraBottomBar extends StatefulWidget {
  const SaraBottomBar({super.key});

  @override
  State<SaraBottomBar> createState() => _SaraBottomBarState();
}

class _SaraBottomBarState extends State<SaraBottomBar> {
  ...
  static const selectedColor = Color.fromRGBO(227, 212, 212, 1);
  static const otherIconeColor = Color.fromARGB(255, 231, 194, 58);
