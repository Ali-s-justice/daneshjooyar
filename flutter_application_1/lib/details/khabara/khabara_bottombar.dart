...
class KhabaraBottomBar extends StatefulWidget {
  const KhabaraBottomBar({super.key});

  @override
  State<KhabaraBottomBar> createState() => _KhabaraBottomBarState();
}

class _KhabaraBottomBarState extends State<KhabaraBottomBar> {
